 ...
 * @author prasanna
 */
public class ProfessorModeljFrame extends javax.swing.JFrame {

    /**
     * Creates new form NewModelJFrame
     */
    
    static ArrayList<String> al2 = new ArrayList();
    static ArrayList<StudentProfileModel> al3 = new ArrayList();
     static StudentCatalog sd;
     static ArrayList<String> mainList = new ArrayList<>();
      static  ArrayList<String> mainList1 = new ArrayList<>();
      static String grade ;

    public ProfessorModeljFrame() {
        initComponents();
        prepareData();
    ...
    private void StdlgnbtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_StdlgnbtnMouseClicked
        ...
        //        StudentProfileModel student = sd.findStudent("1");
    ...
    private void StdlgnbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StdlgnbtnActionPerformed
        ...
        ArrayList<String> sl=  getProfessorList("Fall2023",id);
        jButton1.setText(sl.get(0));
        ArrayList<StudentProfileModel> sl1 = getStudentTakenByProf("info 5100",sd);
       
        for(int i=0;i<sl1.size();i++){
            mainList.add(sl1.get(i).getPerson().getPersonId());
            mainList1.add(sl1.get(i).getCourseLoadBySemester("Fall2023").getSeatassignments().get(i).getGrade());
        }
       // System.out.println("*** "+sl1.get(0).getPerson().getPersonId());
         //       System.out.println("++++ "+sl1.get(0).getCourseLoadBySemester("Fall2023").getSeatassignments().get(0).getGrade());
...
//System.out.println(mainList1);
    ...
    public static void prepareData()
    {
        ...
        FacultyProfileModel facultyProfile = new FacultyProfileModel(person1);
//        facultyProfile.AssignAsTeacher(courseoffer);
//        facultyProfile.getCourseOffer("info 5100");
       //  CoursesOffer courseoffer1 = courseschedule.newCourseOffer("info 6100");
        
      //  courseoffer1.generatSeats(20);
        
       
        PersonRoleModel person = pd.newPerson("100");
        sd = department.getStudentDirectory();
        StudentProfileModel student = sd.newStudentProfile(person);
        ArrayList<StudentProfileModel> studentlist = new ArrayList<>();
...
//        }
      //  System.out.println("Total: " +fp.getCourseOffer("info 5100"));
       ...
       // CoursesSchedule courseschedule1 = new CoursesSchedule();
    ...
    public static ArrayList<StudentProfileModel> getStudentTakenByProf(String courseID, StudentCatalog sd){
    ...
    public static void setGrade(String courseID, StudentCatalog sd , String grade , String studentId){
    ...
    {
        DepartmentModel department = sd.getDepartment();
        CoursesSchedule courseSchedule = department.getCourseSchedule("Fall2023");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewModelJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfessorModeljFrame().setVisible(true);
                prepareData();
            }
        });
    }
